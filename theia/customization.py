...
LABEL_TARGETS = (
    ...
    "usage_input_cache_miss",
    "usage_input_cache_hit",
    "usage_input_tokens",
    "usage_main_agent_tokens",
    "usage_subagent_tokens",
    "usage_output_tokens",
    "usage_total_tokens",
    "usage_total_processed_tokens",
    "usage_api_equivalent",
    "usage_estimated_api_cost",
    "usage_show_details",
    "usage_hide_details",
    "usage_detail_system_instructions",
    "usage_detail_identity_self_model",
    "usage_detail_memory_data",
    "usage_detail_skill_data",
    "usage_detail_user_history",
    "usage_detail_tool_definitions",
    "usage_detail_tool_results",
    "usage_detail_routing_context",
    "usage_detail_subagent_usage",
    "usage_detail_model_pricing",
    "usage_detail_reasoning_tokens",
    "usage_detail_retries_failed",
    "usage_detail_retries",
    "usage_detail_failed_turns",
    "usage_detail_api_calls",
    "usage_detail_subagent_turns",
    "usage_detail_long_running_turns",
    "usage_detail_unattributed_overhead",
    "credits_balance",
    "credits_status",
