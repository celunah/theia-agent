...
CODEX_MEMORY_RESTART_BACKOFF_ENV = "THEIA_CODEX_MEMORY_RESTART_BACKOFF"
...
DEFAULT_CODEX_MEMORY_RESTART_BACKOFF = 30.0
MAX_CODEX_MEMORY_RESTART_BACKOFF = 15 * 60.0
MAX_CODEX_MEMORY_TURN_RETRIES = 3
...
_SELF_IMPROVEMENT_HISTORY_LIMIT = 128
_SELF_IMPROVEMENT_HISTORY_DISPLAY_LIMIT = 20
_SELF_IMPROVEMENT_AUDIT_REASON_MAX_CHARACTERS = 180
_SELF_IMPROVEMENT_SKILL_NAME_RE = re.compile(r"^[A-Za-z0-9][A-Za-z0-9._-]{0,79}$")
_SELF_IMPROVEMENT_AUDIT_ID_RE = re.compile(r"^imp-[0-9a-f]{8,32}(?:-revert)?$")
...
DEFAULT_MOOD_CLASSIFICATION_TIMEOUT = 8.0
DEFAULT_ATTENTION_CLASSIFICATION_TIMEOUT = 2.0
...
ATTENTION_HISTORICAL_CONTEXT_MAX_CHARACTERS = 12 * 1024
