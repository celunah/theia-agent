...
Create `.env`, add your Discord bot token, create both bind-mount source
directories as the deploying account, then run:
...
identity (`1000:1000`) automatically. Theia keeps her private data and working
